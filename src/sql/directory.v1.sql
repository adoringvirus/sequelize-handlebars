...
CREATE TABLE USER_STATUSES (
  id bigserial,
  user_status_name VARCHAR(50) UNIQUE,
...
CREATE TABLE USER_FEATURES (
  id bigserial,
  user_feature_name VARCHAR(50) UNIQUE,
...
CREATE TABLE FILMAKING_MEMBERS_AND_MEMBER_ROLES_RELATION(
  id bigserial,
  filmaking_member_role_id int,
...
FOREIGN KEY (filmaking_member_id) references FILMAKING_MEMBERS(id);

ALTER TABLE FILMAKING_MEMBERS_AND_MEMBER_ROLES_RELATION
ADD CONSTRAINT FK_MEMBER_ROLES_AND_FILMAKEING_MEMBERS_RELATION
FOREIGN KEY (filmaking_member_role_id) references FILMAKING_MEMBERS_ROLES(id);


ALTER TABLE FILMAKING_MEMBERS_AND_MOVIES_RELATION
ADD CONSTRAINT FK_FILMAKING_MEMBERS_TO_MOVIES
FOREIGN KEY (filmaking_member_id) references FILMAKING_MEMBERS(id);

ALTER TABLE FILMAKING_MEMBERS_AND_MOVIES_RELATION
ADD CONSTRAINT FK_MOVIES_TO_FILMAKING_MEMBERS
FOREIGN KEY (movie_id) references MOVIES(id);
...
values          ('admin', 'admin', 'administrator', '','admin@email.com', '', '', '7/19/2021', null, null, '7/19/2021');
